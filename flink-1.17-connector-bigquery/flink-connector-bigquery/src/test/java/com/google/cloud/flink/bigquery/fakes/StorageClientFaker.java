...
public class StorageClientFaker {
        ...
        public static class FakeBigQueryServices implements BigQueryServices {
                ...
                static FakeBigQueryServices getInstance(
                                ...
                                FakeBigQueryStorageWriteClient storageWriteClient,
                                FakeQueryDataClient queryDataClient) {
                        FakeBigQueryServices instance = Mockito.spy(
                ...
                public static final java.util.concurrent.atomic.AtomicInteger STORAGE_READ_CLIENT_INVOCATIONS = new java.util.concurrent.atomic.AtomicInteger(
                                0);
                ...
                public static class FakeQueryDataClient implements QueryDataClient {
                        ...
                        static FakeQueryDataClient defaultInstance = Mockito
                                        .spy(new FakeQueryDataClient(true, null, null, null));
                ...
                public static class FakeBigQueryServerStream
                        ...
                        public FakeBigQueryServerStream(
                                ...
                                this.toReturn = createResponse(
                                                schema,
                                                dataGenerator
                                                                .apply(new RecordGenerationParams(schema,
                                                                                size.intValue()))
                                                                .stream()
                                                                .skip(offset)
                ...
                public static class FakeBigQueryStorageReadClient implements StorageReadClient {
                        ...
                        private final SerializableFunction<RecordGenerationParams, List<GenericRecord>> dataGenerator;
                        private final Double errorPercentage;
                ...
                public static class FakeBigQueryStorageWriteClient implements StorageWriteClient {
                        ...
                        public FakeBigQueryStorageWriteClient(
                                ...
                                OngoingStubbing stubbing = Mockito.when(
                                                mockedWriter.append(Mockito.any(ProtoRows.class), Mockito.anyLong()));
        ...
        public static final String SIMPLE_AVRO_SCHEMA_STRING = "{\"namespace\": \"project.dataset\",\n"
                        ...
                        + "}";
        public static final String SIMPLE_AVRO_SCHEMA_FORQUERY_STRING = "{\"namespace\": \"project.dataset\",\n"
                        + " \"type\": \"record\",\n"
                        ...
                        + SIMPLE_AVRO_SCHEMA_FIELDS_STRING
                        + "}";
        public static final Schema SIMPLE_AVRO_SCHEMA = new Schema.Parser().parse(SIMPLE_AVRO_SCHEMA_STRING);

        public static final TableSchema SIMPLE_BQ_TABLE_SCHEMA = new TableSchema()
                        .setFields(
                                        Arrays.asList(
        ...
        public static ReadSession fakeReadSession(
                ...
                List<ReadStream> readStreams = IntStream.range(0, expectedReadStreamCount)
        ...
        public static List<ReadRowsResponse> createResponse(
                ...
                return IntStream.range(0, genericRecords.size())
                                .collect(
                                                ...
                                                (map, idx) -> map.computeIfAbsent(idx / 1024, key -> new ArrayList<>())
                                ...
                                .map(
                                                genRecords -> {
                                                        try {
                                                                ...
                                                                Encoder binaryEncoder = ENCODER_FACTORY
                                                                ...
                                                                throw new RuntimeException(
                                                                                "Problems generating faked response.",
                                                                                ex);
                                                        }
                                                })
                                .collect(Collectors.toList());
                ...
                return BigQueryReadOptions.builder()
                                ...
                                .setBigQueryConnectOptions(
                                                BigQueryConnectOptions.builder()
                                                                ...
                                                                .setTestingBigQueryServices(
                                                                                () -> {
                                                                                        return FakeBigQueryTableServices
                                                                                                        .getInstance(
                                                                                                                        new StorageClientFaker.FakeBigQueryServices.FakeBigQueryStorageReadClient(
                                                                                                                                        StorageClientFaker
                                                                                                                                                        .fakeReadSession(
        ...
        public static BigQueryConnectOptions createConnectOptionsForWrite(
                ...
                FakeBigQueryServices.FakeBigQueryStorageWriteClient writeClient = new FakeBigQueryServices.FakeBigQueryStorageWriteClient(
                                appendResponse);
        ...
        public static BigQueryConnectOptions createConnectOptionsForQuery(
                        ...
                        RuntimeException createDatasetError,
                        RuntimeException createTableError) {
                FakeBigQueryServices.FakeQueryDataClient queryClient = new FakeBigQueryServices.FakeQueryDataClient(
        ...
        public static BigQueryConnectOptions createConnectOptions(
                ...
                return BigQueryConnectOptions.builder()
                                ...
                                .setTestingBigQueryServices(
                                                () -> {
                                                        return FakeBigQueryServices.getInstance(readClient,
                                                                        writeClient);
                                                })
                                .build();
        }

        public static final TableSchema SIMPLE_BQ_TABLE_SCHEMA_TABLE = new TableSchema()
                        .setFields(
                                        Arrays.asList(
                                                        new TableFieldSchema()
                                                                        .setName("id")
        ...
        public static class FakeBigQueryTableServices implements BigQueryServices {
                ...
                static FakeBigQueryTableServices getInstance(
                                ...
                                FakeBigQueryServices.FakeBigQueryStorageWriteClient storageWriteClient,
                                FakeBigQueryServices.FakeQueryDataClient queryDataClient) {
                        FakeBigQueryTableServices instance = Mockito.spy(
                ...
                static FakeBigQueryTableServices getInstance(
                        ...
                        return getInstance(
                                        storageReadClient,
                                        storageWriteClient,
                                        (FakeBigQueryServices.FakeQueryDataClient) FakeQueryTableDataClient
                                                        .getInstance());
                }
                ...
                static class FakeQueryTableDataClient extends FakeBigQueryServices.FakeQueryDataClient {
                        ...
                        static FakeQueryTableDataClient defaultTableInstance = Mockito
                                        .spy(new FakeQueryTableDataClient(true, null, null, null));
