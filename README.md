...
Use `flink-1.17-connector-bigquery-1.2.0.jar` for connector library jar as created by maven's default packaging.

###### Shaded Jar

Use `flink-1.17-connector-bigquery-1.2.0-shaded.jar` for connector library jar bundled with relevant dependencies,
...
| `quotaProjectId`            | String                 | Google Cloud Project ID for billing / qutoa purposes                                                                                                                                          |
