...
/**
 * Committer implementation for {@link BigQuerySink}.
 *
 * <p>This class commits records staged by {@link BigQueryWriter} between two checkpoints.
 */
public class BigQueryCommitter implements Committer<BigQueryCommittable>, Closeable {
    ...
    public void commit(Collection<CommitRequest<BigQueryCommittable>> commitRequests)
        ...
        throw new UnsupportedOperationException("Method commit is not supported");
    }
