...
public class BigQueryUtils {
    ...
    private static final Long BACKOFF_DELAY_IN_SECONDS = 10L;
    private static final Long BACKOFF_MAX_DELAY_IN_MINUTES = 5L;
    private static final Double RETRY_JITTER_PROB = 0.2;
    ...
    public static Dataset datasetInfo(Bigquery client, String projectId, String datasetId)
        ...
        return executeOperation(
                buildRetriableExecutorForOperation("GetDataset"),
