...
public class StorageClientFaker {
                ...
                this.toReturn =
                        Lists.newArrayList(
                                createResponse(
                                        ...
                                        dataGenerator
                                                .apply(
                                                        new RecordGenerationParams(
                                                                schema, size.intValue()))
                                                .stream()
                                                .skip(offset)
    ...
    public static ReadRowsResponse createResponse(
            String schemaString,
        ...
        try {
            ...
            return ReadRowsResponse.newBuilder()
                    ...
                    .setAvroSchema(AvroSchema.newBuilder().setSchema(schema.toString()).build())
                    .setRowCount(genericRecords.size())
                    .setStats(
            ...
            throw new RuntimeException("Problems generating faked response.", ex);
        }
    }
