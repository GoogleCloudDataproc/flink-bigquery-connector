...
public class SinkTest {
    ...
    //            //            return  tableSchema;
    //
    //            System.out.println("@prashastia: Fields(0): Getting Schema via BQ Client");
    //
    ...
    //                    BigQueryUtils.newBigqueryBuilder(
    //
    // readOptions.getBigQueryConnectOptions().getCredentialsOptions())
    //                            .build();
    ...
    //                            .execute();
    //            com.google.api.services.bigquery.model.TableSchema tableSchema3 =
    // table1.getSchema();
    //            //                System.out.println("Schema Another Method " +
    //            // tableSchema3.toString());
    ...
    //                            .build()
    //                            .getService();
    //            TableId tableId = TableId.of("bqrampupprashasti", "Prashasti", "sink_table");
