...
import com.google.cloud.flink.bigquery.util.avro.AvroToRowDataConverters.AvroToRowDataConverter;
...
public class AvroToRowDataConvertersTest {
  ...
  public void createRowConverterTest() {
    ...
    AvroToRowDataConverter createRowConverter =
        AvroToRowDataConverters.createRowConverter(rowType, readSessionFieldNames, selectedFields);
