...
public class BigQueryConnectorException extends RuntimeException {
	...
	public BigQueryConnectorException(com.google.cloud.bigquery.connector.common.BigQueryErrorCode unsupported,
			String format) {
		this.errorCode = null;
	}

	public BigQueryConnectorException(com.google.cloud.bigquery.connector.common.BigQueryErrorCode unknown,
