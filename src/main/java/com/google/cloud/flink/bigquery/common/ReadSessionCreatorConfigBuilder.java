...
public class ReadSessionCreatorConfigBuilder {
	...
	public ReadSessionCreatorConfigBuilder setArrowCompressionCodec(CompressionCodec arrowCompressionCodec) {
		this.arrowCompressionCodec = arrowCompressionCodec;
		return this;
	}

	public ReadSessionCreatorConfig build() {
		return new ReadSessionCreatorConfig(viewsEnabled, materializationProject, materializationDataset,
				materializationExpirationTimeInMinutes, readDataFormat, maxReadRowsRetries, viewEnabledParamName,
				maxParallelism, defaultParallelism, requestEncodedBase, endpoint, backgroundParsingThreads,
				pushAllFilters, prebufferResponses, streamsPerPartition, arrowCompressionCodec);
	}
}
