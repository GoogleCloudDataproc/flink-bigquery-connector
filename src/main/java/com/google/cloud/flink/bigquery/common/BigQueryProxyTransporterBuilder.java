...
public class BigQueryProxyTransporterBuilder {
	...
	public static ApiFunction<ManagedChannelBuilder, ManagedChannelBuilder> createGrpcChannelConfigurator(
			...
			public ManagedChannelBuilder apply(ManagedChannelBuilder input) {
				return input.proxyDetector(new ProxyDetector() {
					...
					public ProxiedSocketAddress proxyFor(SocketAddress targetServerAddress) {
						HttpConnectProxiedSocketAddress.Builder proxySocketBuilder = HttpConnectProxiedSocketAddress
								.newBuilder().setTargetAddress((InetSocketAddress) targetServerAddress)
	...
	public static HttpTransportFactory createHttpTransportFactory(Optional<URI> proxyAddress,
		...
		if (proxyUsername.isPresent() && proxyPassword.isPresent()) {
			Credentials proxyCredentials = new UsernamePasswordCredentials(proxyUsername.get(), proxyPassword.get());
	...
	public static void checkProxyParamsValidity(Optional<String> proxyUsername, Optional<String> proxyPassword)
