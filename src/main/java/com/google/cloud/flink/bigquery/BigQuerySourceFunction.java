...
public final class BigQuerySourceFunction extends RichParallelSourceFunction<RowData>
	...
	public BigQuerySourceFunction(DeserializationSchema<RowData> deserializer, LinkedList<String> readSessionStreams,
	...
	public void run(SourceContext<RowData> ctx) throws Exception {
		...
		Options options = new ReadRowsHelper.Options(/* maxRetries= */ 5, Optional.of("endpoint"),
				/* backgroundParsingThreads= */ 5, /* prebufferResponses= */ 1);
