 ...
 * Modelled after {@link com.google.api.gax.tracing.ApiTracer}
 *
 * <p>
 * A single instance of a tracer corresponds with a single logical stream from
 * the service.
 *
 * <p>
...
public interface BigQueryStorageReadRowsTracer extends Serializable {
	...
	/**
	 * Indicates a fully decoded element has been requested by spark (i.e. Arrow
	 * RecordBatch).
	 */
	...
	/**
	 * Must only be called before any calls are made to the tracer. This is intended
	 * for cases when multiple threads might be used for processing one stream.
